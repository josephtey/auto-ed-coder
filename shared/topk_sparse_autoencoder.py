...
# Code modified from https://github.com/EleutherAI/sae/blob/main/sae/sae.py

@dataclass
class TopKSaeConfig(Serializable):
    """
...
class TopKSparseAutoencoder(nn.Module):
    ...
    def load_from_hub(
        ...
        *,
        ...
        with open(path / "cfg.json", "r") as f:
            ...
            cfg = TopKSaeConfig.from_dict(cfg_dict, drop_extra_fields=True)

        sae = TopKSparseAutoencoder(d_in, cfg, device=device, decoder=decoder)
        load_model(
            model=sae,
    ...
    def decode(self, top_acts: Tensor, top_indices: Tensor) -> Tensor:
        ...
        return acts @ W_dec.mT + self.b_dec
